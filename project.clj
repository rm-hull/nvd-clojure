(defproject nvd-clojure "3.4.0"
  ...
  :dependencies [[org.clojure/clojure "1.11.0"]
                 ...
                 [org.owasp/dependency-check-core "8.3.1"]
                 [rm-hull/table "0.7.1"]
                 ...
                 [org.apache.maven.resolver/maven-resolver-transport-http "1.9.10" #_"Fixes a CVE"]
                 [org.yaml/snakeyaml "2.0" #_"Fixes a CVE"]
                 [org.apache.maven/maven-core "3.9.2" #_"Fixes a CVE"]
                 [org.eclipse.jetty/jetty-client "12.0.0.beta1" #_"Fixes a CVE" :exclusions [org.slf4j/slf4j-api]]
                 [org.apache.maven.resolver/maven-resolver-spi "1.9.10" #_"Satisfies :pedantic?"]
                 [org.apache.maven.resolver/maven-resolver-api "1.9.10" #_"Satisfies :pedantic?"]
                 [org.apache.maven.resolver/maven-resolver-util "1.9.10" #_"Satisfies :pedantic?"]
                 [org.apache.maven.resolver/maven-resolver-impl "1.9.10" #_"Satisfies :pedantic?"]
                 [org.apache.maven/maven-resolver-provider "3.9.2" #_"Satisfies :pedantic?"]
