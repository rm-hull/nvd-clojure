(defproject nvd-clojure "4.0.0"
  ...
  :dependencies [[org.clojure/clojure "1.11.1"]
                 ...
                 [org.owasp/dependency-check-core "9.0.10"]
                 [rm-hull/table "0.7.1"]
                 ...
                 [org.eclipse.jetty/jetty-client "12.0.7" #_"Fixes a CVE" :exclusions [org.slf4j/slf4j-api]]
  ...
  :profiles {:dev {:plugins [[lein-cljfmt "0.7.0"]
                   ...
                   :eastwood {:add-linters [:boxed-math
                                            :performance]}
                   :dependencies [[clj-kondo "2024.03.13"]
