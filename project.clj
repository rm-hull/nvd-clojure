(defproject nvd-clojure "1.5.0"
  ...
  :dependencies [[org.clojure/clojure "1.10.3"]
                 ...
                 [org.clojure/tools.deps.alpha "0.12.1036" :exclusions [org.slf4j/jcl-over-slf4j]]
                 ...
                 [org.apache.maven.resolver/maven-resolver-transport-http "1.7.1" #_"Fixes a CVE"]
                 [org.apache.maven/maven-core "3.8.2" #_"Fixes a CVE"]
                 [org.eclipse.jetty/jetty-client "11.0.6" #_"Fixes a CVE"]
                 [org.apache.maven.resolver/maven-resolver-spi "1.7.1" #_"Satisfies :pedantic?"]
                 [org.apache.maven.resolver/maven-resolver-api "1.7.1" #_"Satisfies :pedantic?"]
