(defproject nvd-clojure "2.11.0"
  ...
  :dependencies [[org.clojure/clojure "1.11.0"]
                 ...
                 [org.apache.maven.resolver/maven-resolver-transport-http "1.9.2" #_"Fixes a CVE"]
                 [org.yaml/snakeyaml "1.33" #_"Fixes a CVE"]
                 [org.apache.maven/maven-core "3.8.7" #_"Fixes a CVE"]
                 [org.eclipse.jetty/jetty-client "12.0.0.alpha3" #_"Fixes a CVE" :exclusions [org.slf4j/slf4j-api]]
                 [org.apache.maven.resolver/maven-resolver-spi "1.9.2" #_"Satisfies :pedantic?"]
                 [org.apache.maven.resolver/maven-resolver-api "1.9.2" #_"Satisfies :pedantic?"]
                 [org.apache.maven.resolver/maven-resolver-util "1.9.2" #_"Satisfies :pedantic?"]
                 [org.apache.maven.resolver/maven-resolver-impl "1.9.2" #_"Satisfies :pedantic?"]
                 [org.apache.maven/maven-resolver-provider "3.8.7" #_"Satisfies :pedantic?"]
  ...
  :profiles {:dev {:plugins [[lein-cljfmt "0.7.0"]
                   ...
                   :eastwood {:add-linters [:boxed-math
                                            :performance]}
                   :dependencies [[clj-kondo "2022.12.10"]
